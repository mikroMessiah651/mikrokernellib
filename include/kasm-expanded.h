 ...
 *   • Statement macros for no-operand instructions (use like: hlt; or if(..) {
 * cli; }) • static inline functions for instructions that take C variable
 * operands
 *
...
static inline uint64_t read_rax(void) {
    uint64_t v;
    __asm__ volatile("mov %%rax,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rbx(void) {
    uint64_t v;
    __asm__ volatile("mov %%rbx,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rcx(void) {
    uint64_t v;
    __asm__ volatile("mov %%rcx,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rdx(void) {
    uint64_t v;
    __asm__ volatile("mov %%rdx,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rsi(void) {
    uint64_t v;
    __asm__ volatile("mov %%rsi,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rdi(void) {
    uint64_t v;
    __asm__ volatile("mov %%rdi,%0" : "=r"(v));
    return v;
}
...
static inline uint64_t read_r8(void) {
    uint64_t v;
    __asm__ volatile("mov %%r8, %0" : "=r"(v));
    return v;
}
static inline uint64_t read_r9(void) {
    uint64_t v;
    __asm__ volatile("mov %%r9, %0" : "=r"(v));
    return v;
}
static inline uint64_t read_r10(void) {
    uint64_t v;
    __asm__ volatile("mov %%r10,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_r11(void) {
    uint64_t v;
    __asm__ volatile("mov %%r11,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_r12(void) {
    uint64_t v;
    __asm__ volatile("mov %%r12,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_r13(void) {
    uint64_t v;
    __asm__ volatile("mov %%r13,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_r14(void) {
    uint64_t v;
    __asm__ volatile("mov %%r14,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_r15(void) {
    uint64_t v;
    __asm__ volatile("mov %%r15,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_rip(void) {
    uint64_t v;
    __asm__ volatile("lea 0(%%rip),%0" : "=r"(v));
    return v;
}

static inline void write_rax(uint64_t v) {
    __asm__ volatile("mov %0,%%rax" ::"r"(v) : "rax");
}
static inline void write_rbx(uint64_t v) {
    __asm__ volatile("mov %0,%%rbx" ::"r"(v) : "rbx");
}
static inline void write_rcx(uint64_t v) {
    __asm__ volatile("mov %0,%%rcx" ::"r"(v) : "rcx");
}
static inline void write_rdx(uint64_t v) {
    __asm__ volatile("mov %0,%%rdx" ::"r"(v) : "rdx");
}
static inline void write_rsi(uint64_t v) {
    __asm__ volatile("mov %0,%%rsi" ::"r"(v) : "rsi");
}
static inline void write_rdi(uint64_t v) {
    __asm__ volatile("mov %0,%%rdi" ::"r"(v) : "rdi");
}
static inline void write_r8(uint64_t v) {
    __asm__ volatile("mov %0,%%r8" ::"r"(v) : "r8");
}
static inline void write_r9(uint64_t v) {
    __asm__ volatile("mov %0,%%r9" ::"r"(v) : "r9");
}
static inline void write_r10(uint64_t v) {
    __asm__ volatile("mov %0,%%r10" ::"r"(v) : "r10");
}
static inline void write_r11(uint64_t v) {
    __asm__ volatile("mov %0,%%r11" ::"r"(v) : "r11");
}
static inline void write_r12(uint64_t v) {
    __asm__ volatile("mov %0,%%r12" ::"r"(v) : "r12");
}
static inline void write_r13(uint64_t v) {
    __asm__ volatile("mov %0,%%r13" ::"r"(v) : "r13");
}
static inline void write_r14(uint64_t v) {
    __asm__ volatile("mov %0,%%r14" ::"r"(v) : "r14");
}
static inline void write_r15(uint64_t v) {
    __asm__ volatile("mov %0,%%r15" ::"r"(v) : "r15");
}
...
static inline uint64_t read_dr1(void) {
    uint64_t v;
    __asm__ volatile("mov %%dr1,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_dr2(void) {
    uint64_t v;
    __asm__ volatile("mov %%dr2,%0" : "=r"(v));
    return v;
}
static inline uint64_t read_dr3(void) {
    uint64_t v;
    __asm__ volatile("mov %%dr3,%0" : "=r"(v));
    return v;
}
...
static inline void write_dr1(uint64_t v) {
    __asm__ volatile("mov %0,%%dr1" ::"r"(v));
}
static inline void write_dr2(uint64_t v) {
    __asm__ volatile("mov %0,%%dr2" ::"r"(v));
}
static inline void write_dr3(uint64_t v) {
    __asm__ volatile("mov %0,%%dr3" ::"r"(v));
}
...
static inline void write_ds(uint16_t v) {
    __asm__ volatile("movl %0,%%ds" ::"r"((uint32_t)v));
}
static inline void write_es(uint16_t v) {
    __asm__ volatile("movl %0,%%es" ::"r"((uint32_t)v));
}
static inline void write_fs(uint16_t v) {
    __asm__ volatile("movl %0,%%fs" ::"r"((uint32_t)v));
}
static inline void write_gs(uint16_t v) {
    __asm__ volatile("movl %0,%%gs" ::"r"((uint32_t)v));
}
static inline void write_ss(uint16_t v) {
    __asm__ volatile("movl %0,%%ss" ::"r"((uint32_t)v));
}
...
static inline void write_fsbase(uint64_t v) {
    __asm__ volatile("wrfsbase %0" ::"r"(v));
}
static inline void write_gsbase(uint64_t v) {
    __asm__ volatile("wrgsbase %0" ::"r"(v));
}
...
static inline void lidt(const desc_ptr_t* p) {
    __asm__ volatile("lidt (%0)" ::"r"(p) : "memory");
}
static inline void lgdt(const desc_ptr_t* p) {
    __asm__ volatile("lgdt (%0)" ::"r"(p) : "memory");
}
static inline void sidt(desc_ptr_t* p) {
    __asm__ volatile("sidt (%0)" ::"r"(p) : "memory");
}
static inline void sgdt(desc_ptr_t* p) {
    __asm__ volatile("sgdt (%0)" ::"r"(p) : "memory");
}
...
static inline uint16_t sldt_r(void) {
    uint16_t v;
    __asm__ volatile("sldt %0" : "=rm"(v));
    return v;
}
static inline uint16_t str_r(void) {
    uint16_t v;
    __asm__ volatile("str  %0" : "=rm"(v));
    return v;
}
...
static inline void clflush(void* a) {
    __asm__ volatile("clflush    (%0)" ::"r"(a) : "memory");
}
static inline void clflushopt(void* a) {
    __asm__ volatile("clflushopt (%0)" ::"r"(a) : "memory");
}
static inline void clwb(void* a) {
    __asm__ volatile("clwb       (%0)" ::"r"(a) : "memory");
}

/* Software prefetch hints */
static inline void prefetcht0(const void* a) {
    __asm__ volatile("prefetcht0  (%0)" ::"r"(a));
}
static inline void prefetcht1(const void* a) {
    __asm__ volatile("prefetcht1  (%0)" ::"r"(a));
}
static inline void prefetcht2(const void* a) {
    __asm__ volatile("prefetcht2  (%0)" ::"r"(a));
}
static inline void prefetchnta(const void* a) {
    __asm__ volatile("prefetchnta (%0)" ::"r"(a));
}
...
static inline uint64_t xchg64(uint64_t* addr, uint64_t val) {
    __asm__ volatile("xchg %0,%1" : "+m"(*addr), "+r"(val)::"memory");
    return val;
}
...
static inline uint64_t cmpxchg64(uint64_t* addr, uint64_t expected,
                                 uint64_t desired) {
...
static inline uint32_t cmpxchg32(uint32_t* addr, uint32_t expected,
                                 uint32_t desired) {
    __asm__ volatile("lock cmpxchg %2,%0"
                     : "+m"(*addr), "+a"(expected)
                     : "r"(desired)
...
static inline uint64_t xadd64(uint64_t* addr, uint64_t inc) {
    __asm__ volatile("lock xadd %0,%1" : "+r"(inc), "+m"(*addr)::"memory");
    return inc;
}
...
static inline int lock_bts64(uint64_t* base, uint64_t bit) {
    int c;
    __asm__ volatile("lock bts %2,%1; setc %b0"
                     : "=r"(c), "+m"(*base)
                     : "r"(bit)
                     : "memory", "cc");
    return c;
...
static inline int lock_btr64(uint64_t* base, uint64_t bit) {
    int c;
    __asm__ volatile("lock btr %2,%1; setc %b0"
                     : "=r"(c), "+m"(*base)
                     : "r"(bit)
                     : "memory", "cc");
    return c;
...
static inline int lock_btc64(uint64_t* base, uint64_t bit) {
    int c;
    __asm__ volatile("lock btc %2,%1; setc %b0"
                     : "=r"(c), "+m"(*base)
                     : "r"(bit)
                     : "memory", "cc");
    return c;
...
static inline int bsf64(uint64_t v) {
    int r;
    __asm__ volatile("bsf  %1,%0" : "=r"(r) : "r"(v) : "cc");
    return r;
}
static inline int bsr64(uint64_t v) {
    int r;
    __asm__ volatile("bsr  %1,%0" : "=r"(r) : "r"(v) : "cc");
    return r;
}
static inline int bsf32(uint32_t v) {
    int r;
    __asm__ volatile("bsfl %1,%0" : "=r"(r) : "r"(v) : "cc");
    return r;
}
static inline int bsr32(uint32_t v) {
    int r;
    __asm__ volatile("bsrl %1,%0" : "=r"(r) : "r"(v) : "cc");
    return r;
}

/* Bit test (non-atomic) — returns old bit value */
static inline int bt64(const uint64_t* b, uint64_t bit) {
    int c;
    __asm__ volatile("bt  %2,%1; setc %b0"
                     : "=r"(c)
                     : "m"(*b), "r"(bit)
                     : "cc");
    return c;
}
static inline int bts64(uint64_t* b, uint64_t bit) {
    int c;
    __asm__ volatile("bts %2,%1; setc %b0"
                     : "=r"(c), "+m"(*b)
                     : "r"(bit)
                     : "cc");
    return c;
}
static inline int btr64(uint64_t* b, uint64_t bit) {
    int c;
    __asm__ volatile("btr %2,%1; setc %b0"
                     : "=r"(c), "+m"(*b)
                     : "r"(bit)
                     : "cc");
    return c;
}
static inline int btc64(uint64_t* b, uint64_t bit) {
    int c;
    __asm__ volatile("btc %2,%1; setc %b0"
                     : "=r"(c), "+m"(*b)
                     : "r"(bit)
                     : "cc");
    return c;
...
static inline int popcnt64(uint64_t v) {
    uint64_t r;
    __asm__ volatile("popcntq %1,%0" : "=r"(r) : "r"(v));
    return (int)r;
}
static inline int popcnt32(uint32_t v) {
    uint32_t r;
    __asm__ volatile("popcntl %1,%0" : "=r"(r) : "r"(v));
    return (int)r;
}

/* Leading/trailing zero count (requires LZCNT/TZCNT — BMI1) */
static inline int lzcnt64(uint64_t v) {
    uint64_t r;
    __asm__ volatile("lzcntq %1,%0" : "=r"(r) : "r"(v) : "cc");
    return (int)r;
}
static inline int lzcnt32(uint32_t v) {
    uint32_t r;
    __asm__ volatile("lzcntl %1,%0" : "=r"(r) : "r"(v) : "cc");
    return (int)r;
}
static inline int tzcnt64(uint64_t v) {
    uint64_t r;
    __asm__ volatile("tzcntq %1,%0" : "=r"(r) : "r"(v) : "cc");
    return (int)r;
}
static inline int tzcnt32(uint32_t v) {
    uint32_t r;
    __asm__ volatile("tzcntl %1,%0" : "=r"(r) : "r"(v) : "cc");
    return (int)r;
}

/* Byte swap */
static inline uint64_t bswap64(uint64_t v) {
    __asm__ volatile("bswapq %0" : "=r"(v) : "0"(v));
    return v;
}
static inline uint32_t bswap32(uint32_t v) {
    __asm__ volatile("bswapl %0" : "=r"(v) : "0"(v));
    return v;
}

/* Rotate left / right */
static inline uint64_t rol64(uint64_t v, uint8_t n) {
    __asm__ volatile("rolq %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint64_t ror64(uint64_t v, uint8_t n) {
    __asm__ volatile("rorq %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint32_t rol32(uint32_t v, uint8_t n) {
    __asm__ volatile("roll %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint32_t ror32(uint32_t v, uint8_t n) {
    __asm__ volatile("rorl %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint16_t rol16(uint16_t v, uint8_t n) {
    __asm__ volatile("rolw %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint16_t ror16(uint16_t v, uint8_t n) {
    __asm__ volatile("rorw %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint8_t rol8(uint8_t v, uint8_t n) {
    __asm__ volatile("rolb %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
static inline uint8_t ror8(uint8_t v, uint8_t n) {
    __asm__ volatile("rorb %%cl,%0" : "+r"(v) : "c"(n) : "cc");
    return v;
}
...
static inline void xsetbv(uint32_t xcr, uint64_t val) {
    __asm__ volatile("xsetbv" ::"c"(xcr), "a"((uint32_t)val),
                     "d"((uint32_t)(val >> 32)));
}
static inline void xsave(void* area, uint64_t mask) {
    __asm__ volatile("xsave (%0)" ::"r"(area), "a"((uint32_t)mask),
                     "d"((uint32_t)(mask >> 32))
                     : "memory");
}
static inline void xrstor(const void* area, uint64_t mask) {
    __asm__ volatile("xrstor (%0)" ::"r"(area), "a"((uint32_t)mask),
                     "d"((uint32_t)(mask >> 32))
                     : "memory");
}
